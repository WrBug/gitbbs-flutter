...
class BrowseHistoryListAdapter extends DynamicFlowAdapter<BrowseHistoryPageState> {
  BrowseHistoryListAdapter()
      : super(
...
class _IssueConnector
    implements Connector<BrowseHistoryPageState, List<ItemBean>> {
  @override
  List<ItemBean> get(BrowseHistoryPageState state) {
  ...
  @override
  void set(BrowseHistoryPageState state, List<ItemBean> substate) {
